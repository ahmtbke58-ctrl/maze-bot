...
{ q: "UEFA Kupası'nı kazanan ilk ve tek Türk takımı hangisidir? 🇹🇷", opts: ["⚽ Fenerbahçe", "⚽ Beşiktaş", "⚽ Galatasaray"], a: 2 },
    ...
    { q: "Mustafa Kemal Atatürk'ün doğum yılı? 🇹🇷", opts: ["🗓️ 1880", "🗓️ 1881", "🗓️ 1885"], a: 1 },
  ...
  // --- TÜRK DİZİLERİ VE BAŞROLLER (30 Soru) ---
    ...
    { q: "Telefonun şarjı çabuk bitiyorsa çözüm nedir? 🔋", opts: ["💡 Parlaklığı Kıs", "📸 Sürekli Foto Çek", "🔊 Sesi Aç"], a: 0 },
    { q: "Evde elektrik kesilirse ilk ne kontrol edilir? 💡", opts: ["🚪 Kapı Kilidi", "⚡ Sigorta Kutusu", "🚰 Musluk"], a: 1 },
    { q: "Dünyanın en büyük sakız balonu rekoru kaç İnç ⏰", opts: ["🛌 15", "⏰ 20", "☕ 25"], a: 1 },
    { q: "E-posta şifreni unutursan ne yaparsın? 🔑", opts: ["🆕 Yeni PC Al", "📧 Şifremi Unuttum", "📞 Polisi Ara"], a: 1 },
    { q: "Toplu taşımada kartın yetersizse ne olur? 💳", opts: ["🚌 Binemezsin", "🚲 Yürürsün", "🔄 Bakiye Yükle"], a: 2 },
    { q: "Market poşetini evde unuttuysan ne yaparsın? 🛍️", opts: ["📦 Karton Kutu Kullan", "🏃 Koşarak Kaç", "🍎 Meyveleri At"], a: 0 },
    { q: "Gözlerin ekrandan yorulursa ne yapmalısın? 👀", opts: ["🎮 Daha Çok Oyna", "🛌 Dinlendir", "📱 Yakından Bak"], a: 1 },
    ...
    { q: "Kıyafetine sakız yapışırsa neyle çıkar? 🧊", opts: ["🔑 İPLİK", "🧊 Buz", "✂️ Makas"], a: 1 },
    { q: "Bitkilerin kurumuşsa ne eksiktir? 🪴", opts: ["🌬️ Hava", "💧 Su", "🎶 Müzik"], a: 1 },
    ...
    { q: "Lavabo tıkanırsa hangisi çözümdür? 🚰", opts: ["🧼 Sabun", "🧴 Lavabo Açıcı", "🧴 Şampuan"], a: 1 },
